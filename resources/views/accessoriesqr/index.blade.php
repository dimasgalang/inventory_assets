...
@include('layout.sidebar')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Accessories QR List</h1>
                    <div>
                        <form method="GET" action="{{ route('accessoriesqr.batchqr') }}" >
                        ...
                        <!-- <a href="{{ route('accessoriesqr.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                        <h6 class="m-0 font-weight-bold text-primary">Accessories QR Data</h6>
                            ...
                            <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $accessoriesqr->supplier }}</td>
                                        <td>{{ $accessoriesqr->contract_no }}</td>
                                        <td>{{ $accessoriesqr->delivery_note_no }}</td>
                                        <td>{{ $accessoriesqr->invoice_no }}</td>
                                        <td>{{ $accessoriesqr->style }}</td>
                                        <td>{{ $accessoriesqr->item_code }}</td>
                                        <td>{{ $accessoriesqr->item_name }}</td>
                                        <td>{{ $accessoriesqr->item_category }}</td>
                                        <td>{{ $accessoriesqr->random_qr_code }}</td>
                                        <td class="text-center"><img id="qr" src="{{url('/storage/accessoriesqr/'. $accessoriesqr->qr_code)}}" style="width: 150;"></td>
        ...
        <div class="modal fade" id="stickerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md" role="accessoriesqr" >
                        ...
                        <form method="GET" action="{{ route('pdf.generatePDF') }}">
                            ...
                            <div>
                                ...
                                <select class="form-control" id="from_assets_number" name="from_assets_number" required>
                                    <option></option>
                                    @foreach ($accessoriesqrs as $accessoriesqr )
                                        <option value="{{ $accessoriesqr->assets_number }}">{{ $accessoriesqr->assets_number }} - {{ $accessoriesqr->item_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
        ...
        <div class="modal fade" id="pdfModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="accessoriesqr" >
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md" role="document" >
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="modal-title" class="modal-title" id="exampleModalLabel">Import Accessories Assets</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">x</span>
                        </button>
                    </div>
                    <form action="{{ route('accessoriesqr.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div class="modal-body">
...
<script type="text/javascript">
    $('.btn-show-pdf').on('click', function () {
        $('#pdf-src').attr('src', '../../storage/accessoriesqr/' + $(this).data('show-link'));
